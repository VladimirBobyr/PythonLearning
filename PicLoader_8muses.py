...
url_start = 'https://www.8muses.com/comics/album/Various-Authors/NLT-Media/Family-Vacation'
page = requests.get(url_start) #-- Un-comment in case not on work

inputfile = "script_8muses.txt"
myfile = open(inputfile, mode="w", encoding="latin_1")
myfile.write(page.text)
myfile.close()

author, seria, album = get_authorname(url_start)
print('Author: ' + author)
print('Seria: ' + seria)
print('Album: ' + album)

images_list = get_images(inputfile)
